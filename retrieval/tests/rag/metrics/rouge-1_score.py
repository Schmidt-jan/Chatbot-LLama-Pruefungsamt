...
def rouge1_score(retrieved: str, expexted: str, embedding: SentenceTransformerEmbeddings | None = None, keywords: list[str] | None = None) -> float:
    rouge = Rouge()
...
def get_assert(output, context) -> Union[bool, float, Dict[str, Any]]:
    ...
    return calculate_documents_score(test_config, rouge1_score, METRIC, ScoreCalculationType.AVG)
