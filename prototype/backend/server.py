...
template = """ANSWER ONLY IN GERMAN AND ONLY TO ONE QUESTION, THAT YOU RECEIVE WITH THE KNOWLEDGE OF THE GIVEN CONTEXT. IF YOU CANT ANSWER
BASED ON THE GIVEN CONTEXT WRITE 'Ich weiß es nicht'. Bitte NUR DIE ERSTE FRAGE BEANTWORTEN UND KEINE WEITEREN. Wenn die Frage nichtt als Frage
zum Kontext gehört dann gib zurück "Bitte stelle eine Frage zu Prüfungsangelegenheiten".
{context}
